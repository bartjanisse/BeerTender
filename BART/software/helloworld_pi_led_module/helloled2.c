 ...
 * 
 * helloled2.c: Creates a read/write char device for switching on and off
 * a LED which is connected to GPIO14 (pin 8) from the Raspberry Pi.
 * 
 * notes:
 * 		- use make to build this module.
 * 		- use make install to copy the following files to the Pi /bin directory:
 * 			o  helloled2.ko		The module.
